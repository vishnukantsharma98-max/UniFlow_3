...
import { BookResource } from './BooksData';
import { useTheme } from '../ThemeSystem';

interface BookResourceCardProps {
  resource: BookResource;
  onOpenResource: (resource: BookResource) => void;
}
...
export const BookResourceCard: React.FC<BookResourceCardProps> = ({
  ...
  return (
    <div
      id={`book-resource-card-${resource.id}`}
      style={{
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform shrink-0">
