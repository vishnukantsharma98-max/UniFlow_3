...
import { SocialMediaItem } from './SocialMediaData';
import { useTheme } from '../ThemeSystem';

interface SocialMediaCardProps {
  item: SocialMediaItem;
  onOpenItem: (item: SocialMediaItem) => void;
}
    ...
    >
      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-3 mb-4">
          <div className={`w-13 h-13 rounded-2xl bg-gradient-to-br ${item.gradient} flex items-center justify-center text-white shadow-md group-hover:scale-105 transition-transform shrink-0`}>
      ...
      <div className="mt-6 pt-4 border-t border-black/5 dark:border-white/10 space-y-3">
        ...
        >
          <span>{item.isDirectAccess ? 'Open Directly' : 'Open Platform'}</span>
