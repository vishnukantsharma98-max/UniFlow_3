...
export const VishnuCosmicCenterpiece: React.FC<VishnuCosmicCenterpieceProps> = ({
  ...
  return (
    <div className="relative w-full min-h-[460px] h-[500px] sm:h-[560px] lg:h-[620px] flex items-center justify-center select-none overflow-visible">
      ...
      <div className="absolute w-[280px] h-[280px] sm:w-[420px] sm:h-[420px] rounded-full border border-purple-500/20 pointer-events-none animate-gravity-wave-1" />
      <div className="absolute w-[280px] h-[280px] sm:w-[420px] sm:h-[420px] rounded-full border border-pink-500/15 pointer-events-none animate-gravity-wave-2" />

      {/* Solar Rays SVG Layer */}
      <div 
      ...
      >
        <svg 
          className="w-[420px] h-[420px] sm:w-[560px] sm:h-[560px] opacity-70 animate-solar-rays" 
          viewBox="0 0 400 400" 
          fill="none"
        >
          <defs>
            <radialGradient id="solarCenterGlowCore" cx="50%" cy="50%" r="50%">
              ...
              <stop offset="35%" stopColor="#ec4899" stopOpacity="0.18" />
      ...
      >
        <svg 
          className="w-full h-full max-w-[680px] max-h-[680px] overflow-visible" 
        ...
        >
          ...
          <circle cx="-160" cy="-90" r="2.5" fill="#f43f5e" className="animate-pulse" />
          <circle cx="180" cy="110" r="3" fill="#fbbf24" opacity="0.8" />
          <circle cx="210" cy="-80" r="2" fill="#c084fc" />
          <circle cx="-200" cy="120" r="2.5" fill="#38bdf8" />
        </svg>
      </div>

      {/* ================= 3. VISHNU'S REAL PHOTO — THE CENTRAL ANCHOR ================= */}
      <div 
        className="relative z-10 w-full max-w-[270px] sm:max-w-[320px] md:max-w-[340px] rounded-[34px] p-[2.5px] bg-gradient-to-tr from-amber-500 via-fuchsia-500 to-violet-600 animate-solar-corona shadow-[0_15px_45px_rgba(236,72,153,0.32)] transition-all duration-300 hover:scale-[1.01]"
        style={{
          transform: `translate3d(${parallaxX}px, ${parallaxY}px, 0)`
        }}
      >
        <div className="w-full bg-[#0c0820] rounded-[32px] overflow-hidden relative flex flex-col justify-between p-3.5 sm:p-4.5 shadow-2xl border border-purple-500/30">
          
          {/* Subtle Ambient Halo */}
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(245,158,11,0.16)_0%,rgba(217,70,239,0.14)_40%,rgba(12,8,32,0.96)_80%)] pointer-events-none" />
          
          {/* Glowing Golden Corona Rays Behind Portrait */}
          <div className="absolute top-4 left-1/2 -translate-x-1/2 w-48 h-48 rounded-full bg-gradient-to-br from-amber-400/25 via-pink-500/20 to-purple-500/25 blur-2xl pointer-events-none" />

          {/* Top Status Badges */}
          <div className="relative z-10 w-full flex items-center justify-between">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/15 border border-amber-500/30 backdrop-blur-md shadow-xs">
            ...
            <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-purple-500/15 border border-purple-500/30 text-[10px] font-semibold text-purple-300 backdrop-blur-md">
          ...
          <div className="relative z-10 w-full flex-1 flex flex-col items-center justify-center my-2 sm:my-2.5">
            <div className="relative w-44 h-56 sm:w-48 sm:h-64 flex items-center justify-center">
              ...
              {/* Background Aura */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-purple-500/30 via-pink-400/30 to-amber-400/30 blur-lg animate-pulse" />

              {/* Photo Frame */}
              <div className="relative w-full h-full rounded-2xl overflow-hidden border-2 border-purple-400/60 shadow-[0_12px_32px_rgba(0,0,0,0.55)] bg-slate-950 group">
                <img
                  ...
                  loading="eager"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0c0820]/60 via-transparent to-transparent pointer-events-none" />
              </div>

              {/* Solar Core Glow */}
              <div className="absolute -bottom-2 w-36 h-5 bg-gradient-to-r from-amber-400/40 via-pink-400/40 to-purple-400/40 rounded-full blur-md pointer-events-none" />
            </div>

            {/* Founder Label */}
            <div className="mt-2.5 text-center">
              <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-white/[0.08] border border-purple-500/40 shadow-xs backdrop-blur-md">
              ...
              <p className="text-[10px] sm:text-xs text-purple-300 font-semibold mt-0.5">
          ...
          {/* Connect Bar */}
          <div className="relative z-10 w-full p-2 rounded-xl bg-white/[0.04] border border-white/10 backdrop-blur-xl flex items-center justify-between">
            <span className="text-[10px] text-slate-300 font-semibold pl-1">
              Direct Connect:
            </span>
            <div className="flex items-center gap-1.5">
              ...
              <a
                ...
                className="p-1 rounded-lg bg-pink-500/15 hover:bg-pink-500/25 border border-pink-500/30 text-pink-300 transition-all hover:scale-110"
              >
              ...
              <a
                ...
                className="p-1 rounded-lg bg-blue-500/15 hover:bg-blue-500/25 border border-blue-500/30 text-blue-300 transition-all hover:scale-110"
              >
      ...
      {COSMIC_FEATURE_ORBS.map((orb) => {
        ...
        const currentScale = isHovered ? coords.scale * 1.15 : coords.scale;
        ...
        return (
          ...
          >
            {/* Luminous Orb + Glass Pill Flex Container */}
            <div className="flex items-center gap-2.5 p-1.5 sm:p-2 rounded-full backdrop-blur-xl border transition-all duration-200 shadow-lg"
              style={{
                backgroundColor: theme.pillBg,
                borderColor: isHovered ? theme.border : theme.pillBorder,
                boxShadow: isHovered 
                  ? `0 0 25px ${theme.glow}, 0 10px 30px rgba(0,0,0,0.5)` 
                  : `0 4px 18px rgba(0,0,0,0.4), 0 0 10px ${theme.glow}`
              }}
            >
              {/* 3D Glossy Planet Sphere */}
              <div 
                className="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full flex items-center justify-center shrink-0 overflow-hidden shadow-inner border"
                style={{
                  background: theme.orbBg,
                  borderColor: theme.border,
                  boxShadow: `inset -2px -3px 6px rgba(0,0,0,0.6), inset 2px 2px 5px rgba(255,255,255,0.4), 0 0 14px ${theme.glow}`
                }}
              >
                {/* 3D Specular Light Reflection Highlight (Gloss sheen) */}
              ...
              <div className="flex flex-col pr-2 text-left min-w-[70px] sm:min-w-[84px]">
                <div className="flex items-center gap-1">
                  <span className="text-[11px] sm:text-xs font-bold text-zinc-100 tracking-tight whitespace-nowrap">
                    {orb.title}
                  </span>
                  {isHovered && (
                ...
                <span className={`text-[9px] sm:text-[10px] font-medium tracking-tight whitespace-nowrap ${theme.tagColor} opacity-90`}>
