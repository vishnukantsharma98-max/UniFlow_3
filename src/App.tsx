...
export default function App() {
  ...
  // Public Landing Page: /
  return (
    <div className="min-h-screen bg-[#06040e] text-slate-100 selection:bg-purple-600 selection:text-white relative font-sans">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <span className="text-xs font-bold text-white">Google Authentication</span>
                {toastMessage.isError ? (
              ...
              <p className="text-[11px] text-slate-300 mt-0.5 leading-snug">{toastMessage.text}</p>
            </div>
          </div>
          <button 
            onClick={() => setToastMessage(null)}
